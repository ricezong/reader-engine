...
@JsonIgnoreProperties("variableMap", "infoHtml", "tocHtml", "config", "rootDir", "readConfig", "realAuthor", "unreadChapterNum", "folderName", "kindList", "_userNameSpace", "bookDir", "userNameSpace")
data class Book(
